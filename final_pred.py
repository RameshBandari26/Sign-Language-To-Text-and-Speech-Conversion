...
class Application:
    ...
    def __init__(self):
        ...
        self.root.geometry("1100x700")  # reduced width, better fit on screen

        # Camera feed
        self.panel = tk.Label(self.root)
        self.panel.place(x=80, y=3, width=380, height=450)

        # Processed frame
        self.panel2 = tk.Label(self.root)
        self.panel2.place(x=600, y=115, width=380, height=380)

        # Title
        self.T = tk.Label(self.root)
        self.T.place(x=200, y=5)
        self.T.config(text="Sign Language To Text Conversion", font=("Courier", 26, "bold"))

        # Current Character
        self.T1 = tk.Label(self.root)
        self.T1.place(x=10, y=530)
        self.T1.config(text="Character :", font=("Courier", 24, "bold"))

        self.panel3 = tk.Label(self.root)
        self.panel3.place(x=230, y=530)

        # Sentence
        self.T3 = tk.Label(self.root)
        self.T3.place(x=10, y=580)
        self.T3.config(text="Sentence :", font=("Courier", 24, "bold"))

        self.panel5 = tk.Label(self.root)
        self.panel5.place(x=230, y=580)

        # Suggestions
        self.T4 = tk.Label(self.root)
        self.T4.place(x=10, y=630)
        self.T4.config(text="Suggestions :", fg="red", font=("Courier", 22, "bold"))

        # Suggestion buttons
        self.b1 = tk.Button(self.root)
        self.b1.place(x=330, y=630, width=100, height=40)

        self.b2 = tk.Button(self.root)
        self.b2.place(x=450, y=630, width=100, height=40)

        self.b3 = tk.Button(self.root)
        self.b3.place(x=570, y=630, width=100, height=40)

        self.b4 = tk.Button(self.root)
        self.b4.place(x=690, y=630, width=100, height=40)

        # Control buttons
        self.clear = tk.Button(self.root)
        self.clear.place(x=830, y=630, width=100, height=40)
        self.clear.config(text="Clear", font=("Courier", 16), command=self.clear_fun)

        self.speak = tk.Button(self.root)
        self.speak.place(x=950, y=630, width=100, height=40)
        self.speak.config(text="Speak", font=("Courier", 16), command=self.speak_fun)
        
        self.backspace = tk.Button(self.root)
        self.backspace.place(x=710, y=630, width=100, height=40)
        self.backspace.config(text="Backspace", font=("Courier", 14), command=self.backspace_fun)
    ...
    def speak_fun(self):
        try:
            text = self.panel5.cget("text")  # assuming this label holds your sentence
            if text.strip():
                engine = pyttsx3.init()
    ...
    def backspace_fun(self):
        ...
        try:
            if len(self.str.strip()) > 0:
                ...
                self.panel5.config(text=self.str, font=("Courier", 26), wraplength=1025)
            else:
